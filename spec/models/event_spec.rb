RSpec.describe Event, type: :model do
  ...
  describe 'scopes' do
    ...
    let( :tag ) { Tag.create( label: "tag", description: "DescriptionTag" )}
    ...
    let!(:first_event) { Event.create( title: "first_event", description: "first", date_event: "2022-05-11", duration_time: "10:15:00.000", place: "Malvarosa", min_number_of_joiners: 1, max_number_of_joiners: 8, price: "5.0", min_age: "18", organizer_id: first_user.id, tag_ids: [tag.id] )}
    let!(:second_event) { Event.create( title: "second_event", description: "second", date_event: "2023-06-16", duration_time: "10:15:00.000", place: "Rio Turia", min_number_of_joiners: 1, max_number_of_joiners: 8, price: "5.0", min_age: "18", organizer_id: second_user.id, tag_ids: [] )}
    let!(:third_event) { Event.create( title: "third_event", description: "third", date_event: "2023-06-18", duration_time: "10:15:00.000", place: "Rio Turia", min_number_of_joiners: 1, max_number_of_joiners: 8, price: "5.0", min_age: "18", organizer_id: second_user.id, tag_ids: [tag.id] )}
