...
ActiveRecord::Schema[7.0].define(version: 2022_06_13_091633) do
  ...
  create_table "events", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.datetime "date_event", precision: nil
    t.float "duration_time"
    t.string "place"
    t.integer "min_number_of_joiners"
    t.integer "max_number_of_joiners"
    t.float "price"
    t.integer "min_age"
    t.datetime "created_at", null: false
  ...
  create_table "user_event_preferences", force: :cascade do |t|
    t.integer "user_id"
    t.integer "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
